"use strict"
module.exports=function(e){return fetch("https://api.riffsy.com/v1/search?key=LIVDSRZULELA&tag="+e).then(function(e){return e.json()}).then(function(e){var r=e.results
